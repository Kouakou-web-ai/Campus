...
export default function CentreFinancier() {
  ...
  const latePaymentsCount = transactions.filter(t => t.status === 'en_retard').length;
  ...
  return (
    <div className="page-transition space-y-6">
      ...
      {/* Alert paiements en retard */}
      {latePaymentsCount > 0 && (
        <div className="bg-red-50 border border-red-200 rounded-2xl px-5 py-4">
          <div className="flex items-center gap-3 mb-3">
            <AlertCircle size={18} className="text-red-500" />
            <h4 className="font-semibold text-red-800">{latePaymentsCount} relances de paiements en attente</h4>
          </div>
          <p className="text-sm text-red-600 mb-3">Action recommandée : envoi de relance automatique par SMS et Email pour recouvrer les arriérés.</p>
          <button className="text-xs font-semibold text-white bg-red-500 hover:bg-red-600 px-4 py-2 rounded-lg transition-colors">
