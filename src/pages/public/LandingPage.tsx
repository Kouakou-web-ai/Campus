          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 text-center lg:text-left space-y-6 animate-fade-up">
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6 pt-4 text-sm text-slate-400">
                {['Sans carte bancaire', 'Essai gratuit 14 jours', 'Support technique local 24/7'].map((t, i) => (
                  <span key={i} className="flex items-center gap-1.5 text-xs sm:text-sm font-medium hover:text-slate-600 transition-colors">
