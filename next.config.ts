...
const nextConfig: NextConfig = {
  ...
  async headers() {
    const cspHeader = [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: https://apis.google.com https://www.gstatic.com https://*.gstatic.com https://ssl.gstatic.com https://www.google.com https://*.google.com https://accounts.google.com https://*.googleapis.com https://identitytoolkit.googleapis.com https://securetoken.googleapis.com https://*.firebaseapp.com https://firebaseapp.com https://*.firebaseio.com https://firebaseio.com https://*.firebasedatabase.app https://*.firebase.google.com https://recaptcha.net https://*.recaptcha.net https://va.vercel-scripts.com https://*.vercel-scripts.com https://vitals.vercel-insights.com https://*.vercel-insights.com https://vercel.live https://*.vercel.app https://cdn.jsdelivr.net https://moncampus.online https://*.moncampus.online",
